...
<div class="offcanvas-menu-wrapper">
    ...
    <nav class="mainmenu mobile-menu">
        <ul>
            <li class="{{ Route::is('welcome') ? 'active' : '' }}"><a href="/">Home</a></li>
            <li class="{{ Route::is('rooms') ? 'active' : '' }}"><a href="{{ route('rooms') }}">Rooms</a></li>
                ...
                <div class="col-lg-10">
                    <div class="nav-menu">
                        <nav class="mainmenu">
                            <ul>
                                <li class="{{ Route::is('welcome') ? 'active' : '' }}"><a href="/">Home</a></li>
                                <li class="{{ Route::is('rooms') ? 'active' : '' }}"><a
                                        href="{{ route('rooms') }}">Rooms</a></li>
                                <li class="{{ Route::is('aboutUs') ? 'active' : '' }}"><a
                                        href="{{ route('aboutUs') }}">About Us</a></li>
                                <li class="{{ Route::is('contactUs') ? 'active' : '' }}"><a
